...
type LayoutRouteId = RouteId | "/(protected)/user" | "/(protected)/user/startup/[startup]/i" | "/(protected)/user/startup/[startup]/rb" | "/(protected)/user/startup/[startup]/rl" | "/(protected)/user/startup/[startup]/rna" | "/(protected)/user/startup/[startup]/rns"
