...
type RouteParams = {  };
type RouteId = '/(protected)/manager/dashboard';
...
type LayoutRouteId = RouteId | "/(protected)/manager/dashboard/pending" | "/(protected)/manager/dashboard/qualified" | "/(protected)/manager/dashboard/rated"
