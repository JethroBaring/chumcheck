...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="flex min-h-screen w-full text-flutter-gray dark:text-flutter-white">${`<div class="hidden w-[280px] border-r bg-muted/40 md:block"><div class="flex h-full max-h-screen flex-col gap-2"><div class="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6"><a href="/" class="flex items-center gap-2 font-semibold">${validate_component(Package2, "Package2").$$render($$result, { class: "h-6 w-6" }, {}, {})} <span class="">${escape(data.startup.name)}</span></a> <div class="ml-auto flex items-center gap-3">${validate_component(Root, "Dialog.Root").$$render($$result, {}, {}, {
    ...
    })}</div></div> <div class="flex-1"><nav class="grid items-start px-2 text-sm font-medium lg:px-4"><a${add_attribute("href", `/manager/startups/${data.startupId}/rl`, 0)}${add_attribute(
      "class",
      ...
      0
							...
							Readiness Level</a> <a${add_attribute("href", `/manager/startups/${data.startupId}/rna`, 0)}${add_attribute(
      "class",
      ...
      0
							...
							Readiness and Needs Assessment</a> <a${add_attribute("href", `/manager/startups/${data.startupId}/rns`, 0)}${add_attribute(
      "class",
      ...
      0
							...
							Recommended Next Step</a> <a${add_attribute("href", `/manager/startups/${data.startupId}/i`, 0)}${add_attribute(
      "class",
      ...
      0
							...
							Initiatives</a> <a${add_attribute("href", `/manager/startups/${data.startupId}/rb`, 0)}${add_attribute(
      "class",
