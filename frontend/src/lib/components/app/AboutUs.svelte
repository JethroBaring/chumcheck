<div class="relative h-full w-full">
	...
	<div class="mx-auto flex h-screen w-4/5 items-center justify-between" id="aboutus">
		<div class="flex flex-1 items-center text-flutter-gray dark:text-flutter-white">
			<div class="flex flex-1 flex-col gap-5">
				<p class="text-4xl font-extrabold">About Us</p>
				<p class="text-2xl font-medium">
					ChumCheck is a dedicated program designed to <br />support startups on their path to
					success. <br />It provides essential resources and guidance <br />to innovative
					entrepreneurs, with a specific focus <br />on incubation and acceleration.
				</p>
			</div>
