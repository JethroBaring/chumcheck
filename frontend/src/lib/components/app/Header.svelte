...
<header
	class="fixed z-10 left-1/2 top-0 flex w-screen -translate-x-1/2 justify-center text-flutter-gray dark:text-flutter-white"
	class:border-b={isBlurred}
	class:backdrop-blur-lg={isBlurred}
>
	<nav class="flex w-4/5 items-center p-[var(--navbar-padding,0.5rem)] px-0">
		...
		<div class="flex-none font-medium">
			<ul class="flex cursor-pointer items-center gap-7 text-sm">
