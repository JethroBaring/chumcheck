...
<div class="flex-1 overflow-scroll" class:hidden={currentActive !== 0}>
	<div class="h-0 flex flex-col gap-5">
		<label class="label" for="data_privacy">
			<span class="label-text text-base"
				>By accomplishing this form, the following personal information will be collected including,
				...
				file or claim in relation to my consent.</span
			>
		</label>
        
		<RadioGroup.Root value={dataPrivacy ? 'true' : 'false'}>
			<div class="flex items-center space-x-2">
				<RadioGroup.Item value="true" id="dataAgree" 
				on:click={() => toggleDataPrivacy()}
				/>
