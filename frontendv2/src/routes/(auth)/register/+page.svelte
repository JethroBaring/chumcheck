...
>
	<form method="post" class="flex items-center justify-center py-12" use:enhance>
		<div class="mx-auto grid w-[350px] gap-6">
            ...
            placeholder="John"
				...
				<div class="grid gap-2">
					...
					<Input name="lastName" id="lastName" type="text" required bind:value={$form.lastName} placeholder="Doe" />
				</div>
				<div class="grid gap-2">
